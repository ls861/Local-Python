...
fileName = '/Users/lester/Documents/GitHub/Local-Python/Astrodeep_mar_2020/param_006/astrodeep_002/mock_catalogue_005_010.fits'
...
fileName = '/Users/lester/Documents/GitHub/Local-Python/Astrodeep_mar_2020/param_006/astrodeep_002/pyp-beagle/data/BEAGLE_summary_catalogue.fits'
data_fits = fits.open(fileName)
...
plt.title('Input Mass (DE) vs Output Mass (DE)', size=size)
...
plt.figure(figsize=(fsize, fsize/2))
plt.title('Input SFR (DE) vs Output SFR (DE)', size=size)
