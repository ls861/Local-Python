...
# =============================================================================
# comparing individual parameters 1
# =============================================================================

params_names = ['mass', 'alpha', 'beta', 'tauVeff', 'metallicity', 'nebularlogU', 'tau', 'nebularxi']
params = [mass, dpl_alpha, dpl_beta, tauV_eff, metallicity, nebular_logU, np.log10(tau), nebular_xi]
params_b1 = [mass_b1, dpl_alpha_b1, dpl_beta_b1, tauV_eff_b1, metallicity_b1, nebular_logU_b1, tau_b1, nebular_xi_b1]

fig, axs = plt.subplots(2, len(params)/2, figsize=(20, 10))
fig.suptitle(title1)
for j in [0, 1]:
