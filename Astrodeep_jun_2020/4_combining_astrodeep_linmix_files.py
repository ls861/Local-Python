...
# NEW fields = ['0A2744C', '1A2744P', '2M0416C', '3M0416P', '4 etc]
#fields = ['0A2744C']
runs = ['001']
...
massLim = '8p0'
redshift_center     = 2.0
redshift_width      = 10.0 # either side
chi2_max            = 9.5
comment             = '001'
...
#        print(catalog.dtype.names)
        ...
        sbf = '/Users/lester/Documents/GitHub/Local-Python/Astrodeep_jun_2020/from_cluster/linmix_npy_files/linmix_inputs_{}/'.format(field[0])
...
from os import path
sbf = './linmix_npy_files_z{}_w{}_chi{}_{}/'.format(zLim, wLim, chi2Lim, comment)

if not path.exists(sbf):
    mkdir(sbf)

sbf = '{}{}_'.format(sbf, massLim) # subfolder NEEDS TO EXIST
...
# =============================================================================
# checking how covariance depends on magnification
# =============================================================================
#
#i=1
#print(GMMx[i])
...
#xsig = 1
#ysig = 1
#xycov = 0 # can vary between -1 and +1
#cov = ((xsig**2,xycov),(xycov, ysig**2))
#
##cov = ((1,1),(1, 1))
#
