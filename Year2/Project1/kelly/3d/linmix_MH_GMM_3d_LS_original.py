...
class Chain(object):
    def __init__(self, xArr, yArr, zArr, xsigArr, ysigArr, zsigArr, xycovArr, xzcovArr, yzcovArr, delta, K, nchains, nGMM_err, pi_err, rng=None):
...
class LinMix(object):
    ...
    """
    def __init__(self, xArr, yArr, zArr, xsigArr=None, ysigArr=None, zsigArr=None, xycovArr=None, xzcovArr=None, yzcovArr=None, delta=None, K=3, nchains=4, parallelize=True, seed=None, nGMM_err=1, pi_err=None):
        self.nchains = nchains
        # lester
#        parallelize = False
        ...
        if self.parallelize:
            ...
            self._chains = []
            for i in range(self.nchains):
                self._chains.append(Chain(xArr, yArr, zArr, xsigArr, ysigArr, zsigArr, xycovArr, xzcovArr, yzcovArr, delta, K, nGMM_err, pi_err, self.nchains))
