...
#            print('werrs ERROR')
    ...
    def initial_guess(self): # Step 1
        ...
        self.alpha_b = 0 #np.random.normal(0.0, 1.0)
        self.alpha_c = 0 #np.random.normal(0.0, 1.0)
        self.alpha = self.calc_alpha(zeta=self.zeta)
        self.beta_a = fit_sample[0]
        self.beta_b = 0 #np.random.normal(0.0, 1.0)
        self.beta_c = 0 #np.random.normal(0.0, 1.0)
...
piBeagle    = np.load(sbf+'pi_err.npy')         # 3x probability of each posterior gaussian
...
proposalscale_alpha_a   = 0.5                   # usually 0.005
proposalscale_alpha_b   = 0.5                   # usually 0.005
proposalscale_alpha_c   = 0.5                   # usually 0.005
proposalscale_beta_a    = 0.05                  # usually 0.005
proposalscale_beta_b    = 0.05                  # usually 0.005
proposalscale_beta_c    = 0.05                  # usually 0.005
...
#lm = LinMix(GMMx, GMMy, GMMz, GMMxsig, GMMysig, GMMzsig, xycovArr=GMMxycov, xzcovArr=GMMxzcov, yzcovArr=GMMyzcov, nGaussXi=nGaussXi, nGaussBeagle=nGaussBeagle, piBeagle=piBeagle, nchains=nChains)
#
#lm.run_mcmc(miniter=minIter, maxiter=maxIter, n_burn=n_burn)
...
#pickle.dump(lm.chain, open('/Users/lester/Documents/linmix_files/lm_chain_redshift_test_003.p','w'))
