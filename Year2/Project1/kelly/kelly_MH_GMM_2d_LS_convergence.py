...
class Chain(object):
    def __init__(self, xArr, yArr, xsigArr, ysigArr, xycovArr, delta, nGaussXi, nchains, nGaussBeagle, piBeagle, rng=None):
#        print('__init__')
...
class LinMix(object):
    ...
    """
    def __init__(self, xArr, yArr, xsigArr=None, ysigArr=None, xycovArr=None, delta=None, nGaussXi=3, nchains=4, parallelize=True, seed=None, nGaussBeagle=1, piBeagle=None):
...
#        self.parallelize = False
        ...
        if self.parallelize:
            ...
            self._chains = []
            for i in range(self.nchains):
                self._chains.append(Chain(xArr, yArr, xsigArr, ysigArr, xycovArr, delta, nGaussXi, nGaussBeagle, piBeagle, self.nchains))
...
# =============================================================================
# NEW SIMPLIFIED ATTEMPT - LOOPING REDSHIFT
# =============================================================================
...
#    nChains     = 1
#    minIter     = 10 # if i%(niter/10.0) == 0:
#    maxIter     = minIter
#    n_burn       = 1 # this is when the proposal distribution starts learning from the previous points

    nChains     = 4
    minIter     = 1000 # if i%(niter/10.0) == 0:, TENTH OF THIS NEEDS TO DIVIDE BY 4, see yellow below
    maxIter     = 10*minIter
    ...
    lm = LinMix(GMMx, GMMy, GMMxsig, GMMysig, xycovArr=GMMxycov, nGaussXi=nGaussXi, nGaussBeagle=nGaussBeagle, piBeagle=piBeagle, nchains=nChains)
