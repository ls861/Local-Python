...
#    data = pickle.load(open('/Users/lester/Documents/GitHub/Local-Python/Year2/Project1/kelly/data/scenario_5_7_data_{}.p'.format(options[i]),'r'))
    ...
    piBeagle                = data['amp_GMM_2d']       # 3x probability of each posterior gaussian
    GMMx                    = data['x_GMM_2d']         # 3x posterior means per mass
    GMMy                    = data['y_GMM_2d']         # 3x posterior means per sfr
    GMMxsig                 = data['xsig_GMM_2d']      # 3x posterior sigmas per mass
    GMMysig                 = data['ysig_GMM_2d']      # 3x posterior sigmas per sfr
    GMMxycov                = data['xycov_GMM_2d']     # 3x posterior covar per mass-sfr pair
...
#    pickle.dump(lm.chain, open('/Users/lester/Documents/linmix_files/lm_chain_scenario_6_7_data_{}_k_convergence_test_009.p'.format(options[i]),'w')) 
