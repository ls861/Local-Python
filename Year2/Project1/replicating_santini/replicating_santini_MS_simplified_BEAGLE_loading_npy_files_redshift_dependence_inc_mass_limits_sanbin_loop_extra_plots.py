...
#%%
    ...
    # data['']
    mass_plot = [data['mass_AD'], data['mass_AD_neb'], data['mass_BEAGLE_stellar'], data['mass_BEAGLE_stellar']]
    sfr_plot = [data['sfr_AD'], data['sfr_AD_neb'], data['sfr_BEAGLE_instant'], data['sfr_SAN']]
    ...
    for i in range(len(mass_plot)):
        ...
        plt.xlim(5, 12)
        plt.ylim(-4, 4)
        plt.scatter(mass_plot[i], sfr_plot[i], alpha=0.02)
        plt.show()
    ...
    for i in range(len(mass_plot)):
        ...
        plt.xlim(5, 12)
        plt.ylim(-4, 4)
        plt.scatter(mass_plot[i]+data['mag_AD'], sfr_plot[i]+data['mag_AD'], alpha=0.02)
        plt.show()
    ...
    for i in range(len(mass_plot)):
        ...
        plt.xlim(5, 12)
        plt.ylim(-4, 4)
        plt.scatter(mass_plot[i], sfr_plot[i], alpha=0.5)
    ...
    for i in range(len(mass_plot)):
        ...
        plt.xlim(5, 12)
        plt.ylim(-4, 4)
        plt.scatter(mass_plot[i]+data['mag_AD'], sfr_plot[i]+data['mag_AD'], alpha=0.5)
        plt.plot(x, beta_san[san_bin]*x + alpha_san[san_bin], color='#2ca02c', label='Santini+17', linewidth=2)
        plt.show()
