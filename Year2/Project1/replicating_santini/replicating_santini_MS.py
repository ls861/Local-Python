...
print(len(id_AD), len(mass_BEAGLE_arr), len(sfr_santini_arr))
...
plt.plot(x, fit0[0]*x + fit0[1], color='r', label='no clipping', linewidth=4)
...
plt.plot(x, fit0[0]*x + fit0[1], color='#1f77b4', label='Without clipping', linewidth=4)
