...
option_BEAGLE_sfr_cut = 0
min_BEAGLE_sfr_cut = -15.0
max_BEAGLE_sfr_cut = 10.0 # max is 5.72931

# PLOTS
plot_BEAGLE_vs_AD = 0
plot_input_to_2sigma = 0
...
for san_bin in san_bins:
    ...
    plt.scatter(data['sfr_AD_neb'], data['sfr_AD'], alpha=a)
    plt.xlim(-3, 4)
    plt.ylim(-3, 4)
    plt.show()
    
    plt.scatter(data['sfr_AD_neb'], data['sfr_SAN'], alpha=a)
    plt.xlim(-3, 4)
    plt.ylim(-3, 4)
    plt.show()
    
    plt.scatter(data['sfr_AD_neb'], data['sfr_BEAGLE_instant'], alpha=a)
    plt.xlim(-3, 4)
    plt.ylim(-3, 4)
    plt.show()
    
    plt.scatter(data['mass_AD'], data['sfr_AD'], alpha=a)
    plt.xlim(5, 12)
    plt.ylim(-3, 4)
    plt.show()
    
    plt.scatter(data['mass_AD'], data['sfr_AD_neb'], alpha=a)
    plt.xlim(5, 12)
    plt.ylim(-3, 4)
    plt.show()
    
    plt.scatter(data['mass_AD'], data['sfr_SAN'], alpha=a)
    plt.xlim(5, 12)
    plt.ylim(-3, 4)
    plt.show()
    
    plt.scatter(data['mass_AD'], data['sfr_BEAGLE_instant'], alpha=a)
    plt.xlim(5, 12)
    plt.ylim(-3, 4)
    plt.show()
    ...
    plt.scatter(data['mass_AD_neb'], data['sfr_BEAGLE_instant'], alpha=a)
    plt.xlim(5, 12)
    plt.ylim(-3, 4)
    plt.show()
    
    plt.scatter(data['mass_BEAGLE_tot'], data['sfr_BEAGLE_instant'], alpha=a)
    plt.xlim(5, 12)
    plt.ylim(-3, 4)
    plt.show()
    
    plt.scatter(data['mass_BEAGLE_stellar'], data['sfr_BEAGLE_instant'], alpha=a)
    plt.xlim(5, 12)
    plt.ylim(-3, 4)
    plt.show()
    ...
    x2 = data['mass_BEAGLE_stellar']
    y2 = data['sfr_BEAGLE_instant']

    plt.figure(figsize=(20, 20))
    for i in range(len(data['mass_AD_neb'])):
...
#        plt.show()
        ...
        plt.scatter(data['sfr_AD_neb'], data['sfr_BEAGLE_instant'], alpha=0.1)
        plt.title('${} < z < {}$'.format(zLow, zHigh))
        plt.xlim(-3, 3)
        plt.ylim(-3, 3)
    ...
    if option_BEAGLE_mass == 0 and option_BEAGLE_sfr == 0:
        idx_data = (data['sfr_AD_neb']>-90.0) # -99.0 is assigned when not enough fluxes are +ve to calculate an SFR (or not enough filters in band, not the case for redshift > 1.3 though)
        mass = data['mass_AD_neb'][data['sfr_AD_neb']>-90.0] 
        sfr = data['sfr_AD_neb'][data['sfr_AD_neb']>-90.0]
        color = color[data['sfr_AD_neb']>-90.0]
        color_rf = color_rf[data['sfr_AD_neb']>-90.0]
