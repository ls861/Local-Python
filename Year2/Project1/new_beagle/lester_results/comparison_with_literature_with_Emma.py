...
plt.scatter(z_lester+ 14*inc, beta_scenario_9_k0_d_Hogg, label='scenario 9 k0 d Hogg')
plt.scatter(z_lester+ 15*inc, beta_scenario_10_k0_d_Hogg, label='scenario 10 k0 d Hogg')
...
plt.errorbar(z_lester+ 14*inc, beta_scenario_9_k0_d_Hogg, yerr=beta_err_scenario_9_k0_d_Hogg, ls='none')
plt.errorbar(z_lester+ 15*inc, beta_scenario_10_k0_d_Hogg, yerr=beta_err_scenario_10_k0_d_Hogg, ls='none')
...
plt.scatter(z_lester+ 14*inc, alpha_scenario_9_k0_d_Hogg, label='scenario 9 k0 d Hogg')
plt.scatter(z_lester+ 15*inc, alpha_scenario_10_k0_d_Hogg, label='scenario 10 k0 d Hogg')
...
plt.errorbar(z_lester+ 14*inc, alpha_scenario_9_k0_d_Hogg, yerr=alpha_err_scenario_9_k0_d_Hogg, ls='none')
plt.errorbar(z_lester+ 15*inc, alpha_scenario_10_k0_d_Hogg, yerr=alpha_err_scenario_10_k0_d_Hogg, ls='none')
...
plt.scatter(z_lester+ 14*inc, alpha_scenario_9_k0_d_Hogg_n, label='scenario 9 k0 d Hogg')
plt.scatter(z_lester+ 15*inc, alpha_scenario_10_k0_d_Hogg_n, label='scenario 10 k0 d Hogg')
...
plt.errorbar(z_lester+ 14*inc, alpha_scenario_9_k0_d_Hogg_n, yerr=alpha_err_scenario_9_k0_d_Hogg_n, ls='none')
plt.errorbar(z_lester+ 15*inc, alpha_scenario_10_k0_d_Hogg_n, yerr=alpha_err_scenario_10_k0_d_Hogg_n, ls='none')


plt.plot(z3d, -0.065 + 0.375*z3d, label='scenario 13, chi2 < 9.5')
plt.plot(z3d, 0.05 + 0.324*z3d, label='scenario 14, chi2 < 20')
