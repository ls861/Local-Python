...
beta_scenario_7_k0_d_Hogg = np.array([0.91, 0.825, 0.762, 0.845, 1.463])
alpha_scenario_7_k0_d_Hogg_n_old = alpha_scenario_7_k0_d_Hogg + (norm*beta_scenario_7_k0_d_Hogg) # santini normalised
alpha_scenario_7_k0_d_Hogg_n = np.array([1.156, 0.886, 1.097, 1.874, 2.764])
alpha_err_scenario_7_k0_d_Hogg = np.array((alpha_scenario_7_k0_d_Hogg-np.array([-8.596, -7.578, -6.957, -8.059, -16.617]),np.array([-6.806, -6.639, -5.732, -5.156, -8.228])-alpha_scenario_7_k0_d_Hogg))
beta_err_scenario_7_k0_d_Hogg = np.array((beta_scenario_7_k0_d_Hogg-np.array([0.805, 0.77, 0.697, 0.695, 1.07]),np.array([1.021, 0.879, 0.837, 1.053, 2.089])-beta_scenario_7_k0_d_Hogg))
alpha_err_scenario_7_k0_d_Hogg_n_old = abs(((((alpha_err_scenario_7_k0_d_Hogg[1]+alpha_err_scenario_7_k0_d_Hogg[0])/2))**2 - (norm*(((beta_err_scenario_7_k0_d_Hogg[1]+beta_err_scenario_7_k0_d_Hogg[0])/2)))**2)) ** 0.5
alpha_err_scenario_7_k0_d_Hogg_n = np.array((alpha_scenario_7_k0_d_Hogg_n-np.array([0.991, 0.818, 1.019, 1.608, 2.167]),np.array([1.323, 0.965, 1.199, 2.161, 3.477])-alpha_scenario_7_k0_d_Hogg_n))

#print(alpha_scenario_7_k0_d_Hogg_n_old)
#print(alpha_scenario_7_k0_d_Hogg_n)
#print(alpha_err_scenario_7_k0_d_Hogg_n_old)
#print(alpha_err_scenario_7_k0_d_Hogg_n)

sig0_scenario_7_k0_d_Hogg = np.array([0.594, 0.203, 0.142, 0.532, 0.353])
sig0_err_scenario_7_k0_d_Hogg = np.array((sig0_scenario_7_k0_d_Hogg-np.array([0.555, 0.169, 0.103, 0.456, 0.245]),np.array([0.639, 0.235, 0.189, 0.6, 0.454])-sig0_scenario_7_k0_d_Hogg))
...
# =============================================================================
# kelly applied to scenario 9 and 10, delayed, with HOGG
# =============================================================================

alpha_scenario_9_k0_d_Hogg = np.array([-0.726, -6.273, -10.329, -10.846, -8.605])
beta_scenario_9_k0_d_Hogg = np.array([-3.278, 0.858, 1.344, 1.435, 1.15])
alpha_scenario_9_k0_d_Hogg_n = alpha_scenario_9_k0_d_Hogg + (norm*beta_scenario_9_k0_d_Hogg) # santini normalised
alpha_err_scenario_9_k0_d_Hogg = np.array((alpha_scenario_9_k0_d_Hogg-np.array([-14.235, -7.721, -11.433, -11.371, -10.212]),np.array([13.822, -4.61, -9.287, -10.164, -6.894])-alpha_scenario_9_k0_d_Hogg))
beta_err_scenario_9_k0_d_Hogg = np.array((beta_scenario_9_k0_d_Hogg-np.array([-4.651, 0.668, 1.225, 1.36, 0.948]),np.array([-1.709, 1.015, 1.464, 1.493, 1.343])-beta_scenario_9_k0_d_Hogg))
alpha_err_scenario_9_k0_d_Hogg_n = abs(((((alpha_err_scenario_9_k0_d_Hogg[1]+alpha_err_scenario_9_k0_d_Hogg[0])/2))**2 - (norm*(((beta_err_scenario_9_k0_d_Hogg[1]+beta_err_scenario_9_k0_d_Hogg[0])/2)))**2)) ** 0.5

alpha_scenario_10_k0_d_Hogg = np.array([-5.747, -6.129, -10.281, -10.661, -8.804])
beta_scenario_10_k0_d_Hogg = np.array([0.699, 0.832, 1.337, 1.414, 1.172])
alpha_scenario_10_k0_d_Hogg_n = alpha_scenario_10_k0_d_Hogg + (norm*beta_scenario_10_k0_d_Hogg) # santini normalised
alpha_err_scenario_10_k0_d_Hogg = np.array((alpha_scenario_10_k0_d_Hogg-np.array([-6.513, -7.515, -11.42, -11.267, -10.581]),np.array([-4.954, -4.38, -9.34, -10.124, -7.301])-alpha_scenario_10_k0_d_Hogg))
beta_err_scenario_10_k0_d_Hogg = np.array((beta_scenario_10_k0_d_Hogg-np.array([0.604, 0.654, 1.231, 1.354, 1.005]),np.array([0.794, 0.995, 1.466, 1.482, 1.381])-beta_scenario_10_k0_d_Hogg))
alpha_err_scenario_10_k0_d_Hogg_n = abs(((((alpha_err_scenario_10_k0_d_Hogg[1]+alpha_err_scenario_10_k0_d_Hogg[0])/2))**2 - (norm*(((beta_err_scenario_10_k0_d_Hogg[1]+beta_err_scenario_10_k0_d_Hogg[0])/2)))**2)) ** 0.5
...
#plt.scatter(z_steinhardt, beta_steinhardt, label='Steinhardt+14')
#plt.errorbar(z_steinhardt, beta_steinhardt, yerr=beta_err_steinhardt, ls='none')
plt.scatter(z_kurc, beta_kurc, label='Kurczynski+16', color='#d62728')
#plt.errorbar(z_kurc, beta_kurc, yerr=beta_err_kurc, ls='none')
...
#plt.scatter(z_lester+inc, beta_scenario_7_k0_d, label='scenario 7 k0 d')
#plt.scatter(z_lester+inc, beta_scenario_7_k0_dd, label='scenario 7 k0 dd')
#plt.scatter(z_lester+inc, beta_scenario_7_k0_dc, label='scenario 7 k0 dc')
plt.scatter(z_lester+inc, beta_scenario_7_k0_d_Hogg, label='scenario 7 k0 d Hogg')
#plt.scatter(z_lester+inc, beta_scenario_7_k0_dd_Hogg, label='scenario 7 k0 dd Hogg')
#plt.scatter(z_lester+inc, beta_scenario_7_k0_dc_Hogg, label='scenario 7 k0 dc Hogg')
#plt.scatter(z_lester+inc, beta_scenario_9_k0_d_Hogg, label='scenario 9 k0 d Hogg')
#plt.scatter(z_lester+inc, beta_scenario_10_k0_d_Hogg, label='scenario 10 k0 d Hogg')
...
#plt.errorbar(z_lester+inc, beta_scenario_7_k0_d, yerr=beta_err_scenario_7_k0_d, ls='none')
#plt.errorbar(z_lester+inc, beta_scenario_7_k0_dd, yerr=beta_err_scenario_7_k0_dd, ls='none')
#plt.errorbar(z_lester+inc, beta_scenario_7_k0_dc, yerr=beta_err_scenario_7_k0_dc, ls='none')
plt.errorbar(z_lester+inc, beta_scenario_7_k0_d_Hogg, yerr=beta_err_scenario_7_k0_d_Hogg, ls='none')
#plt.errorbar(z_lester+inc, beta_scenario_7_k0_dd_Hogg, yerr=beta_err_scenario_7_k0_dd_Hogg, ls='none')
#plt.errorbar(z_lester+inc, beta_scenario_7_k0_dc_Hogg, yerr=beta_err_scenario_7_k0_dc_Hogg, ls='none')
#plt.errorbar(z_lester+inc, beta_scenario_9_k0_d_Hogg, yerr=beta_err_scenario_9_k0_d_Hogg, ls='none')
#plt.errorbar(z_lester+inc, beta_scenario_10_k0_d_Hogg, yerr=beta_err_scenario_10_k0_d_Hogg, ls='none')

plt.plot(z3d, 0.552 + 0.094*z3d, label='scenario 13 k0 d Hogg 3d, chi2 $<$ 9.5, run 120', color='#2ca02c')
plt.plot(z3d, 0.654 + 0.05*z3d, label='scenario 14 k0 d Hogg 3d, chi2 $<$ 20, run 120', color='#2ca02c', linestyle=':')
plt.plot(z3d, 1.406 + -2.489*(1.0/z3d) + 2.226*((1.0/z3d)**2), label='scenario 13 k0 d Hogg 3d, chi2 $<$ 9.5, run 123', color='tab:purple')
plt.plot(z3d, 1.26 + -1.937*(1.0/z3d) + 1.585*((1.0/z3d)**2), label='scenario 13 k0 d Hogg 3d, chi2 $<$ 9.5run 124', color='tab:cyan')


#chain = np.load('/Users/lester/Documents/GitHub/kelly_model/combined_chain_b0.75_3d_Hogg_d_s13_r120.npy')
#print(len(chain))
#for i in range(len(chain)):
##for i in range(100):
#    plt.plot(z3d, chain['beta_a'][i] + chain['beta_b'][i]*z3d, color='tab:gray', alpha=0.002, zorder=0)
...
#plt.scatter(z_salmon, alpha_salmon_n, label='Salmon+15')
#plt.scatter(z_steinhardt, alpha_steinhardt_n, label='Steinhardt+14')
plt.scatter(z_kurc, alpha_kurc_n, label='Kurczynski+16', color='#d62728')
...
#plt.scatter(z_lester+ inc, alpha_scenario_7_k0_d_n, label='scenario 7 k0 d')
#plt.scatter(z_lester+ inc, alpha_scenario_7_k0_dd_n, label='scenario 7 k0 dd')
#plt.scatter(z_lester+ inc, alpha_scenario_7_k0_dc_n, label='scenario 7 k0 dc')
plt.scatter(z_lester+ inc, alpha_scenario_7_k0_d_Hogg_n, label='scenario 7 k0 d Hogg')
#plt.scatter(z_lester+ inc, alpha_scenario_7_k0_dd_Hogg_n, label='scenario 7 k0 dd Hogg')
#plt.scatter(z_lester+ inc, alpha_scenario_7_k0_dc_Hogg_n, label='scenario 7 k0 dc Hogg')
#plt.scatter(z_lester+ inc, alpha_scenario_9_k0_d_Hogg_n, label='scenario 9 k0 d Hogg')
#plt.scatter(z_lester+ inc, alpha_scenario_10_k0_d_Hogg_n, label='scenario 10 k0 d Hogg')
...
#plt.errorbar(z_lester+inc, alpha_scenario_7_k0_d_n, yerr=alpha_err_scenario_7_k0_d_n, ls='none')
#plt.errorbar(z_lester+inc, alpha_scenario_7_k0_dd_n, yerr=alpha_err_scenario_7_k0_dd_n, ls='none')
#plt.errorbar(z_lester+inc, alpha_scenario_7_k0_dc_n, yerr=alpha_err_scenario_7_k0_dc_n, ls='none')
plt.errorbar(z_lester+inc, alpha_scenario_7_k0_d_Hogg_n, yerr=alpha_err_scenario_7_k0_d_Hogg_n, ls='none')
#plt.errorbar(z_lester+inc, alpha_scenario_7_k0_dd_Hogg_n, yerr=alpha_err_scenario_7_k0_dd_Hogg_n, ls='none')
#plt.errorbar(z_lester+inc, alpha_scenario_7_k0_dc_Hogg_n, yerr=alpha_err_scenario_7_k0_dc_Hogg_n, ls='none')
#plt.errorbar(z_lester+inc, alpha_scenario_9_k0_d_Hogg_n, yerr=alpha_err_scenario_9_k0_d_Hogg_n, ls='none')
#plt.errorbar(z_lester+inc, alpha_scenario_10_k0_d_Hogg_n, yerr=alpha_err_scenario_10_k0_d_Hogg_n, ls='none')

plt.plot(z3d, -0.092 + 0.385*z3d, label='scenario 13 k0 d Hogg 3d, chi2 $<$ 9.5, run 120', color='#2ca02c')
plt.plot(z3d, 0.043 + 0.325*z3d, label='scenario 14 k0 d Hogg 3d, chi2 $<$ 20, run 120', color='#2ca02c', linestyle=':')
plt.plot(z3d, -0.008 + 0.365*z3d, label='scenario 13 k0 d Hogg 3d, chi2 $<$ 9.5, run 123', color='tab:purple')
plt.plot(z3d, -0.004 + 0.343*z3d, label='scenario 13 k0 d Hogg 3d, chi2 $<$ 9.5run 124', color='tab:cyan')
...
#for i in range(len(chain)):
##for i in range(100):
#    plt.plot(z3d, chain['alphaN_a'][i] + chain['alphaN_b'][i]*z3d, color='tab:gray', alpha=0.002, zorder=0)
...
plt.scatter(z_lester+ inc, sig0_scenario_7_k0_d_Hogg, label='scenario 7 k0 d Hogg')

plt.errorbar(z_lester+inc, sig0_scenario_7_k0_d_Hogg, yerr=sig0_err_scenario_7_k0_d_Hogg, ls='none')
...
plt.scatter(z_lester+inc, alpha_scenario_7_k0_d, label='scenario 7 k0 d')
plt.scatter(z_lester+inc, alpha_scenario_7_k0_dd, label='scenario 7 k0 dd')
plt.scatter(z_lester+inc, alpha_scenario_7_k0_dc, label='scenario 7 k0 dc')
plt.scatter(z_lester+inc, alpha_scenario_7_k0_d_Hogg, label='scenario 7 k0 d Hogg')
plt.scatter(z_lester+inc, alpha_scenario_7_k0_dd_Hogg, label='scenario 7 k0 dd Hogg')
plt.scatter(z_lester+inc, alpha_scenario_7_k0_dc_Hogg, label='scenario 7 k0 dc Hogg')
plt.scatter(z_lester+inc, alpha_scenario_9_k0_d_Hogg, label='scenario 9 k0 d Hogg')
plt.scatter(z_lester+inc, alpha_scenario_10_k0_d_Hogg, label='scenario 10 k0 d Hogg')
...
plt.errorbar(z_lester+inc, alpha_scenario_7_k0_d, yerr=alpha_err_scenario_7_k0_d, ls='none')
plt.errorbar(z_lester+inc, alpha_scenario_7_k0_dd, yerr=alpha_err_scenario_7_k0_dd, ls='none')
plt.errorbar(z_lester+inc, alpha_scenario_7_k0_dc, yerr=alpha_err_scenario_7_k0_dc, ls='none')
plt.errorbar(z_lester+inc, alpha_scenario_7_k0_d_Hogg, yerr=alpha_err_scenario_7_k0_d_Hogg, ls='none')
plt.errorbar(z_lester+inc, alpha_scenario_7_k0_dd_Hogg, yerr=alpha_err_scenario_7_k0_dd_Hogg, ls='none')
plt.errorbar(z_lester+inc, alpha_scenario_7_k0_dc_Hogg, yerr=alpha_err_scenario_7_k0_dc_Hogg, ls='none')
plt.errorbar(z_lester+inc, alpha_scenario_9_k0_d_Hogg, yerr=alpha_err_scenario_9_k0_d_Hogg, ls='none')
plt.errorbar(z_lester+inc, alpha_scenario_10_k0_d_Hogg, yerr=alpha_err_scenario_10_k0_d_Hogg, ls='none')
