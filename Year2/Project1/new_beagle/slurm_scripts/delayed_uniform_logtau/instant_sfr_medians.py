...
for param in params:
    ...
    pickle.dump({'ID':ID_arr, 'log_instant_sfr_mean':mean_arr, 'log_instant_sfr_median.npy':median_arr, 'log_instant_sfr_median_68_00.npy':interval_arr}, open('./instant_sfr_medians/{}_instant_sfr_medians.p'.format(param[0]),'w'))
