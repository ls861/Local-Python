...
params = ['0A2744C', '1A2744P', '2M0416C', '3M0416P', '4M0717C', '5M0717P', '6M1149C', '7M1149P']
revision = '001'
...
#    log_sfr_arr = []
    ...
    folder = '/home/ls861/rds/rds-rm665-beagle_shared/lester_shared/lester_results/{}/fit_{}/'.format(param, revision)
...
#    log_sfr_arr = np.array(log_sfr_arr)[idx_sort]
    ...
    pickle.dump({'ID':ID_arr, 'log_mStar_arr':log_mStar_arr, 'log_sfr_instant_arr':log_sfr_instant_arr}, open('./sample_outputs/{}{}_BEAGLE_samples.p'.format(param[0], mass_sfr_option),'w'))
...
for param in params:
    ...
    GMM_2d = pickle.load(open('./kelly_2d_GMM_inputs/{}{}_GMM_2d_fits.p'.format(param[0], mass_sfr_option),'r'))
    ...
    pickle.dump({'ID':ID_arr, 'hp_x_arr':hp_x_arr, 'hp_y_arr':hp_y_arr}, open('./sample_outputs/{}{}_GMM_2d_samples.p'.format(param[0], mass_sfr_option),'w'))
...
for param in params:
    ...
    GMM_3d = pickle.load(open('./kelly_3d_GMM_inputs/{}{}_GMM_3d_fits.p'.format(param[0], mass_sfr_option),'r'))
    ...
    pickle.dump({'ID':ID_arr, 'hp_x_arr':hp_x_arr, 'hp_y_arr':hp_y_arr, 'hp_z_arr':hp_z_arr}, open('./sample_outputs/{}{}_GMM_3d_samples.p'.format(param[0], mass_sfr_option),'w'))
