...
# all 8 files
log_file=('/home/ls861/rds/rds-rm665-beagle_shared/lester_shared/lester_run/new_beagle/danger_constant/slurm_automation_log.txt')
...
sub_folder=('fit_002')
slurm_folder=('/home/ls861/rds/rds-rm665-beagle_shared/lester_shared/lester_run/new_beagle/danger_constant')
empty_limit=('50')
