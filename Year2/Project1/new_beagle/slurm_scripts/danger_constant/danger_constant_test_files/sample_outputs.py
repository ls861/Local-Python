...
#    log_sfr_instant_arr = []
    ...
    for file in fileList:
        if '_log_instant_sfr.npy' in file:
            ...
            data = fits.open('./'+ID+'_BEAGLE.fits.gz')
...
#            log_instant_sfr_gz = np.load(folder+file)
...
#    log_sfr_instant_arr = np.array(log_sfr_instant_arr)[idx_sort]
    ...
    pickle.dump({'ID':ID_arr, 'log_mStar_arr':log_mStar_arr, 'log_sfr_arr':log_sfr_arr}, open('./sample_outputs/{}_{}_BEAGLE_samples.p'.format(param, mass_sfr_option),'w'))
    
    
    
test = pickle.load(open('/Users/lester/Documents/GitHub/Local-Python/Year2/Project1/new_beagle/slurm_scripts/danger_constant/danger_constant_test_files/sample_outputs/0__mStar_BEAGLE_samples.p', 'r'))
print(len(test['log_sfr_arr'][0]))    
print(len(test['log_sfr_arr']) )

test = pickle.load(open('/Users/lester/Documents/GitHub/Local-Python/Year2/Project1/new_beagle/lester_results/danger_constant/sample_outputs/0_mStar_BEAGLE_samples_test.p', 'r'))
print(len(test['log_sfr_arr'][0]))    
print(len(test['log_sfr_arr']) )
...
import pickle
import matplotlib.pyplot as plt
testBeagle = pickle.load(open('/Users/lester/Documents/GitHub/Local-Python/Year2/Project1/new_beagle/lester_results/danger_constant/sample_outputs/1_mStar_BEAGLE_samples.p','r'))
test2d = pickle.load(open('/Users/lester/Documents/GitHub/Local-Python/Year2/Project1/new_beagle/lester_results/danger_constant/sample_outputs/1_mStar_GMM_2d_samples.p','r'))
test3d = pickle.load(open('/Users/lester/Documents/GitHub/Local-Python/Year2/Project1/new_beagle/lester_results/danger_constant/sample_outputs/1_mStar_GMM_3d_samples.p','r'))
print(testBeagle.keys())

for i in range(30):
    plt.scatter(testBeagle['log_mStar_arr'][i], testBeagle['log_sfr_arr'][i], label='Beagle')
    plt.scatter(test2d['hp_x_arr'][i], test2d['hp_y_arr'][i], label='GMM 2d')
    plt.scatter(test3d['hp_x_arr'][i], test3d['hp_y_arr'][i], label='GMM 3d')
    plt.title(i)
    plt.legend()
    plt.show()
...
for param in params:
    ...
    pickle.dump({'ID':ID_arr, 'hp_x_arr':hp_x_arr, 'hp_y_arr':hp_y_arr}, open('./sample_outputs/{}_{}_GMM_2d_samples.p'.format(param, mass_sfr_option),'w'))
...
for param in params:
    ...
    pickle.dump({'ID':ID_arr, 'hp_x_arr':hp_x_arr, 'hp_y_arr':hp_y_arr, 'hp_z_arr':hp_z_arr}, open('./sample_outputs/{}_{}_GMM_3d_samples.p'.format(param, mass_sfr_option),'w'))
'''