...
# updated to include the NEW C catalog data from Emma
...
D = np.load('astrodeep_rawfile_1234_ABCZ.npy')
...
#f= open("./BEAGLE_inputs/astrodeep_A2744_c_subset_RF1_001.txt","w+")
#f= open("./BEAGLE_inputs/astrodeep_A2744_p_subset_RF1_001.txt","w+")
#f= open("./BEAGLE_inputs/astrodeep_M0416_c_subset_RF1_001.txt","w+")
#f= open("./BEAGLE_inputs/astrodeep_M0416_p_subset_RF1_001.txt","w+")

#f= open("./BEAGLE_inputs/astrodeep_M0717_c_subset_RF1_001.txt","w+")
#f= open("./BEAGLE_inputs/astrodeep_M0717_p_subset_RF1_001.txt","w+")
#f= open("./BEAGLE_inputs/astrodeep_M1149_c_subset_RF1_001.txt","w+")
#f= open("./BEAGLE_inputs/astrodeep_M1149_p_subset_RF1_001.txt","w+")
