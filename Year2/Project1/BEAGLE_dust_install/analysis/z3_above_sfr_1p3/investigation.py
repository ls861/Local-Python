...
filename = '/Users/lester/Documents/GitHub/Local-Python/Year2/Project1/BEAGLE_dust_install/analysis/z3_above_sfr_1p3/z3_above_sfr_1p3_x29.fits'
...
idx1 = (z_BEAGLE > 13.*z_AD/6.)
idx2 = (z_BEAGLE < 13.*z_AD/6.)&(z_BEAGLE > 10.*z_AD/8.)
idx3 = (z_BEAGLE < 10.*z_AD/8.)&(z_BEAGLE > 3)
idx4 = z_BEAGLE < 3
...
plt.plot(x, (10.*x/8.), color='k')
plt.plot(x, (0.*x+3.), color='k')
plt.xlim(0, 11)
plt.ylim(0, 12)
plt.xlabel('z AD')
plt.ylabel('z BEAGLE')
...
for idx in [idx]:
    ...
    #for i in [10]:  
        ...
        FIELD = int(d[1].data['field_AD'][idx][i])
        SED_B = '/Users/lester/Documents/Project1/BEAGLE_dust_install/analysis/visual_inspection/{}/{}/gz_files/pyp-beagle/plot/{}_BEAGLE_marginal_SED_phot.png'.format(vis, FIELD, int(id_BEAGLE[idx][i]))
        
        SED_AD = '/Users/lester/Documents/Project1/BEAGLE_dust_install/analysis/visual_inspection/{}/{}/AD_SED/SED_F-{}_AD-{}_B-{}.png'.format(vis, FIELD, FIELD, int(id_AD[idx][i]), int(id_BEAGLE[idx][i]))
