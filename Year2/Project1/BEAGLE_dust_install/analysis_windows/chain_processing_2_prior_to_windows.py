...
if load:
    ...
    with open('/Users/lester/Documents/linmix_files/1000_sample_chains/lm_chain_scenario_29_clusters_z1p25-2p0_4x50000_true_linear_alpha_m_sfr_z_corr_alpha_beta_covprop_propscale_rdm_all.p', 'rb') as f:
        chain_MS_29_c1 = pickle.load(f, encoding='latin1')  
    with open('/Users/lester/Documents/linmix_files/1000_sample_chains/lm_chain_scenario_29_clusters_z2p0-3p0_4x50000_true_linear_alpha_m_sfr_z_corr_alpha_beta_covprop_propscale_rdm_all.p', 'rb') as f:
        chain_MS_29_c2 = pickle.load(f, encoding='latin1')  
    with open('/Users/lester/Documents/linmix_files/1000_sample_chains/lm_chain_scenario_29_clusters_z3p0-4p0_4x50000_true_linear_alpha_m_sfr_z_corr_alpha_beta_covprop_propscale_rdm_all.p', 'rb') as f:
        chain_MS_29_c3 = pickle.load(f, encoding='latin1')  
    with open('/Users/lester/Documents/linmix_files/1000_sample_chains/lm_chain_scenario_29_clusters_z4p0-5p0_4x50000_true_linear_alpha_m_sfr_z_corr_alpha_beta_covprop_propscale_rdm_all.p', 'rb') as f:
        chain_MS_29_c4 = pickle.load(f, encoding='latin1')  
    with open('/Users/lester/Documents/linmix_files/1000_sample_chains/lm_chain_scenario_29_clusters_z5p0-6p0_4x50000_true_linear_alpha_m_sfr_z_corr_alpha_beta_covprop_propscale_rdm_all.p', 'rb') as f:
...
#        chain_MS_29_c1k = pickle.load(f, encoding='latin1')
    ...
    with open('/Users/lester/Documents/linmix_files/1000_sample_chains/lm_chain_scenario_29_clusters_z1p25-2p0_4x15000_true_linear_alpha_m_sfr_z_corr_alpha_beta_covprop_propscale_rdm_all_bad_gmm_cuts_limited_outlier.p', 'rb') as f:
        chain_MS_29_c1_lm8p0 = pickle.load(f, encoding='latin1')  
        
    with open('/Users/lester/Documents/linmix_files/1000_sample_chains/lm_chain_scenario_29_clusters_z1p25-2p0_4x15000_true_linear_alpha_m_sfr_z_corr_alpha_beta_covprop_propscale_rdm_all_bad_gmm_cuts_limited_outlier_lm8p5.p', 'rb') as f:
        chain_MS_29_c1_lm8p5 = pickle.load(f, encoding='latin1')  
        
    with open('/Users/lester/Documents/linmix_files/1000_sample_chains/lm_chain_scenario_29_clusters_z1p25-2p0_4x15000_true_linear_alpha_m_sfr_z_corr_alpha_beta_covprop_propscale_rdm_all_bad_gmm_cuts_limited_outlier_lm9p0.p', 'rb') as f:
        chain_MS_29_c1_lm9p0 = pickle.load(f, encoding='latin1')
        
    with open('/Users/lester/Documents/linmix_files/1000_sample_chains/lm_chain_scenario_29_clusters_z3p0-4p0_4x50000_true_linear_alpha_m_sfr_z_corr_alpha_beta_covprop_propscale_rdm_all_no_hogg.p', 'rb') as f:
        chain_MS_29_c3_nohogg = pickle.load(f, encoding='latin1')     
...
#    print(s29z1[1].header)
    ...
    rc_c1_lm8p0 = read_chain(1.25, 2.0, chain_MS_29_c1_lm8p0, 'const_beta_linear_alpha')
...
#    rc_c1k = read_chain(1.25, 2.0, chain_MS_29_c1k, 'const_beta_ssfr_alpha')
    rc_c3_nohogg = read_chain(3.0, 4.0, chain_MS_29_c3_nohogg, 'const_beta_linear_alpha')
...
rcs = [rc_c1, rc_c1_lm8p0, rc_c1_lm8p5, rc_c1_lm9p0, rc_c2, rc_c3, rc_c4, rc_c5, rc_c3_nohogg]
...
for a, ax in enumerate(axes):
    ax.plot(0, 0, color='#1f77b4', label='z1')
    ax.plot(0, 0, color='#ff7f0e', label='z1 lm8p0')
    ax.plot(0, 0, color='#2ca02c', label='z1 lm8p5')
    ax.plot(0, 0, color='#d62728', label='z1 lm9p0')
    ax.plot(0, 0, color='#9467bd', label='z2')
    ax.plot(0, 0, color='#8c564b', label='z3')
    ax.plot(0, 0, color='#e377c2', label='z4')
    ax.plot(0, 0, color='gray', label='z5')
    ax.plot(0, 0, color='yellow', label='z3 no hogg')
    ax.legend(loc='upper right', frameon=False, fontsize=fontsize_legend)

# layout
ylim_low = np.array([0.2, 0.5, 0.0, 0.0, -6.0, 0.0])
ylim_high = np.array([1.5, 4.0, 1.0, 1.0, 6.0, 6.0])
