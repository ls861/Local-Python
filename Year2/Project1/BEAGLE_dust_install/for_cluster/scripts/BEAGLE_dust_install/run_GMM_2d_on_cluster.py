...
np.seterr(all="raise")
os.system("mkdir "+args.folder+"sklearn_GMM_2d_"+fileStr+"/") # folder to store individual GMM fits

# GMM fits
if args.reRun:
    os.system('rm '+args.folder+"sklearn_GMM_2d_"+fileStr+"/*GMM_2d.p") # remove folder to store individual GMM fits
...
os.system('mkdir ./kelly_2d_GMM_inputs/') # folder to store combined file
sbf = './kelly_2d_GMM_inputs/{}_'.format(fold)

if args.reRun:
    os.system('rm '+sbf+'GMM_2d_fits.p') # remove folder to store combined file
