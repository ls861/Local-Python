...
def redshift_bins_4(rc_29_20_c1, rc_29_20_c2, rc_31_20_c3, rc_31_20_c4, normalisation, figuresize, fontsize_legend, fontsize_axes, string_slope, string_normalisation, string_ssfr, string_redshift, save):
    ...
    if save:
        plt.savefig('redshift_bins_4.png', dpi=300, transparent=False, bbox_inches='tight')
    plt.show()