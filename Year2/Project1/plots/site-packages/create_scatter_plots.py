...
if os.path.isfile("/Users/lester/Documents/GitHub/Local-Python/Year2/Project1/plots/overleaf_BEAGLE_dust_install/scatter_plots/matchedCatalogue.fits"):
  print("matchedCatalogue.fits already there, reading this in...")
  matchedCat=fits.open("/Users/lester/Documents/GitHub/Local-Python/Year2/Project1/plots/overleaf_BEAGLE_dust_install/scatter_plots/matchedCatalogue.fits")
else:
...
#        sys.exit()
  ...
  outputDict['UID'] = id
  outputDict['redshiftOrig'] = redshiftOrig
  outputDict['massOrig'] = massOrig
  outputDict['sfrOrig'] = sfrOrig
...
ax1.errorbar(matchedCat[1].data['massBurst'][tempIdx], matchedCat[1].data['sfrBurst'][tempIdx], xerr=[matchedCat[1].data['massErrBurstLow'][tempIdx],matchedCat[1].data['massErrBurstHigh'][tempIdx]], yerr=[matchedCat[1].data['sfrErrBurstLow'][tempIdx],matchedCat[1].data['sfrErrBurstHigh'][tempIdx]], linestyle='', c='tab:gray', zorder=0, lw=0.5, mew=0)

ax1.scatter(matchedCat[1].data['massOrig'][tempIdx], matchedCat[1].data['sfrOrig'][tempIdx], c='tab:blue', label='original', zorder=1E4,s=50)
ax1.scatter(matchedCat[1].data['massBurst'][tempIdx], matchedCat[1].data['sfrBurst'][tempIdx], zorder=1E5,s=50,c='tab:red', label='delayed plus burst of sf')
...
tempIdx = np.where((matchedCat[1].data['redshiftOrig'] > 1.25) & (matchedCat[1].data['redshiftOrig'] < 2) & (matchedCat[1].data['massTau'] > 0) & (matchedCat[1].data['sfrTau'] >= -1.8))[0]
tempIdx2 = np.where((matchedCat[1].data['redshiftOrig'] > 1.25) & (matchedCat[1].data['redshiftOrig'] < 2) & (matchedCat[1].data['massTau'] > 0) & (matchedCat[1].data['sfrTau'] < -1.8))[0]
tempIdx3 = np.where((matchedCat[1].data['redshiftOrig'] > 1.25) & (matchedCat[1].data['redshiftOrig'] < 2) & (matchedCat[1].data['massTau'] > 0))[0]

plt.errorbar(matchedCat[1].data['massTau'][tempIdx3], matchedCat[1].data['sfrTau'][tempIdx3], xerr=[matchedCat[1].data['massErrTauLow'][tempIdx3],matchedCat[1].data['massErrTauHigh'][tempIdx3]], yerr=[matchedCat[1].data['sfrErrTauLow'][tempIdx3],matchedCat[1].data['sfrErrTauHigh'][tempIdx3]], linestyle='', c='tab:gray', zorder=0, lw=0.5, mew=0)



plt.scatter(matchedCat[1].data['massOrig'][tempIdx], matchedCat[1].data['sfrOrig'][tempIdx], c='tab:blue', s=10, label='original', zorder=0)
plt.scatter(matchedCat[1].data['massOrig'][tempIdx2], matchedCat[1].data['sfrOrig'][tempIdx2], c='tab:blue', zorder=1, s=100, edgecolors='k', linewidths=1)
plt.scatter(matchedCat[1].data['massTau'][tempIdx], matchedCat[1].data['sfrTau'][tempIdx], zorder=0, s=10, c='tab:red', label=r'alternative prior on $\tau_{sfr}$')
plt.scatter(matchedCat[1].data['massTau'][tempIdx2], matchedCat[1].data['sfrTau'][tempIdx2], zorder=1, s=100, c='tab:red', edgecolors='k', linewidths=1)
...
# plt.figure()
# tempIdx = np.where((matchedCat[1].data['redshiftOrig'] > 1.25) & (matchedCat[1].data['redshiftOrig'] < 2) & (matchedCat[1].data['massTau'] > 0))[0]
