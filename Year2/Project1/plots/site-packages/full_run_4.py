...
def full_run_4(chain_MS_29_c1, chain_MS_29_c2, chain_MS_29_c3, chain_MS_29_c4, chain_MS_29_c5, s29z1, s29z2, s29z3, s29z4, s29z5, rc_c1, rc_c2, rc_c3, rc_c4, rc_c5, rc_c, normalisation, figuresize, fontsize_legend, fontsize_axes, string_slope, string_normalisation, string_scatter, string_ssfr, string_redshift, save):
    ...
    ax1.fill_between(z_schr, alphaN_schr-alphaN_err_schr, alphaN_schr+alphaN_err_schr, alpha=0.1, color='#8c564b')
    ...
    ax3.errorbar(z_stei, sig_stei, ls='none', marker='x', ms=ms_x, label='Steinhardt+14')
    ax3.plot(3, 0.3)
    ax3.errorbar(z_salm, sig_salm, ls='none', marker='x', ms=ms_x, label='Salmon+15')
    
    ax3.errorbar(z_kurc, sig_kurc, yerr=sig_err_kurc, ls='none', marker='.', ms=ms_dot, label='Kurczynski+16')
    ax3.errorbar(z_sig_sant, sig9p2_sant, ls='none', marker='x', ms=ms_x, label='Santini+17')
    ...
    ax1.legend(loc='upper left', frameon=False, fontsize=1.22*fontsize_legend, ncol=2)
    ...
    ax1.errorbar(z_smit, ssfr_smit, yerr=([ssfr_m_smit], [ssfr_p_smit]), ls='none', marker='.', ms=ms_dot, label='Smit+14')
    ...
    ax1.errorbar(z_pear, ssfr_pear, yerr=ssfr_err_pear, ls='none', marker='x', ms=ms_tri, label='Pearson+18')
    ax1.errorbar(z_thor, ssfr_thor, yerr=ssfr_err_thor, ls='none', marker='x', ms=ms_tri, label='Thorne+21')
