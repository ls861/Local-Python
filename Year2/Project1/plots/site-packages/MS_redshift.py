...
def MS_redshift(ADx_subset, medians, normalisation, figuresize, fontsize_axes, string_mass, string_sfr, save):
    ...
    scatter = ax1.scatter(ADx_subset['mass_BEAGLE_stellar'][idx_sort], ADx_subset['sfr_BEAGLE_instant'][idx_sort], c=ADx_subset['redshift_BEAGLE'][idx_sort], vmin=1.25, vmax=5.8, alpha=1.0)
