...
def lower_mass_limit(mass_completeness_limits_0p90_new, ADx_subset, figuresize, fontsize_legend, fontsize_axes, string_mass, save):
    ...
    ax1.scatter(ADx_subset['redshift_BEAGLE'], ADx_subset['mass_BEAGLE_stellar'] + ADx_subset['mag_AD'], s=30, alpha=1.0, color='k', label='BEAGLE Fitted Mass', zorder=2, marker='.')
