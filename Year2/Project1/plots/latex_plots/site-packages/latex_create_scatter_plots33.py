...
if os.path.isfile("/Users/lester/Documents/GitHub/Local-Python/Year2/Project1/plots/overleaf_BEAGLE_dust_install/scatter_plots/matchedCatalogue_scenario_33.fits"):
  ...
  for i in range(len(photometry[1].data['ID'])):
    ...
    if len(matchOrig) == 1:
      ...
      massOrig.append(LestersSummary[1].data['mass_BEAGLE_stellar'][matchOrig] + LestersSummary[1].data['mag_AD'][matchOrig])
      sfrOrig.append(LestersSummary[1].data['sfr_BEAGLE_instant'][matchOrig] + LestersSummary[1].data['mag_AD'][matchOrig])
...
print('COME ON')
print(matchedCat[1].data['massOrig'][tempIdx])
