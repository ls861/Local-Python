...
#! Name of the job:
#SBATCH -J lester_slurm_001
#! Which project should be charged:
#SBATCH -A MAIOLINO-SL3-CPU
#! Output filename:
#! %A means slurm job ID and %a means array index
#SBATCH --output=photom_DEEP_lester_%A_%a.out
#! Errors filename:
#SBATCH --error=photom_DEEP_lester_%A_%a.err
...
application="/home/ls861/rds/rds-rm665-beagle_shared/eclake_BEAGLE_install/bin/BEAGLE"

#! Run options for the application:
options="--parameter-file /home/ls861/BEAGLE-general/params/astrodeep_fit_photometry_001.param --fit"
...
#! BEAGLE specific environment variables
export BEAGLE_ROOT=/home/ls861/BEAGLE-general
export BEAGLE_PARAM_DIR=$BEAGLE_ROOT/params
export BEAGLE_DATA=$BEAGLE_ROOT/data
export BEAGLE_TEMPLATES=$BEAGLE_ROOT/templates
export BEAGLE_RESULTS=$BEAGLE_ROOT/BEAGLE_RESULTS
