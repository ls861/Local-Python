...
for i in range(len(catalogs_z)):
    ...
    catalogs_z[i] = np.array(catalogs_z[i], dtype=[('field', '<f8'), ('ID', '<f8'), ('ZBEST', '<f8'), ('ZBEST_SIQR', '<f8'), ('MAGNIF', '<f8'), ('ZSPECFLAG', '<f8'), ('chi2', '<f8'), ('MSTAR', '<f8'), ('MASTAR_MIN', '<f8'), ('MSTAR_MAX', '<f8'), ('SFR', '<f8'), ('SFR_MIN', '<f8'), ('SFR_MAX', '<f8'), ('chi2_NEB', '<f8'), ('MASTAR_NEB', '<f8'), ('MASS_MIN_NEB', '<f8'), ('MASS_MAX_NEB', '<f8'), ('SFR_NEB', '<f8'), ('SFR_MIN_NEB', '<f8'), ('SFR_MAX_NEB', '<f8'), ('RELFLAG', '<f8'), ('a_ID', '<f8'), ('a_RA', '<f8'), ('a_DEC', '<f8'), ('a_B435', '<f8'), ('a_V606', '<f8'), ('a_I814', '<f8'), ('a_Y105', '<f8'), ('a_J125', '<f8'), ('a_JH140', '<f8'), ('a_H160', '<f8'), ('a_Ks', '<f8'), ('a_CH1', '<f8'), ('a_CH2', '<f8'), ('a_errB435', '<f8'), ('a_errV606', '<f8'), ('a_errI814', '<f8'), ('a_errY105', '<f8'), ('a_errJ125', '<f8'), ('a_errJH140', '<f8'), ('a_errH160', '<f8'), ('a_errKs', '<f8'), ('a_errCH1', '<f8'), ('a_errCH2', '<f8'), ('b_ID', '<f8'), ('b_B435', '<f8'), ('b_V606', '<f8'), ('b_I814', '<f8'), ('b_Y105', '<f8'), ('b_J125', '<f8'), ('b_JH140', '<f8'), ('b_H160', '<f8'), ('b_Ks', '<f8'), ('b_CH1', '<f8'), ('b_CH2', '<f8'), ('b_errB435', '<f8'), ('b_errV606', '<f8'), ('b_errI814', '<f8'), ('b_errY105', '<f8'), ('b_errJ125', '<f8'), ('b_errJH140', '<f8'), ('b_errH160', '<f8'), ('b_errKs', '<f8'), ('b_errCH1', '<f8'), ('b_errCH2', '<f8')])
    
astrodeep       = np.hstack(catalogs_z)
astrodeep       = astrodeep[astrodeep['ZBEST'] > 0]

print(np.array_equal(astrodeep['ID'], astrodeep['b_ID']))
