...
sfr = A * (msa*np.heaviside(tau-msa, 0) + tau*np.exp((tau-msa)/tau_exp)*np.heaviside(msa-tau, 1))
...
# =============================================================================
# just messing around with LE
# =============================================================================



#xtest = np.linspace(0, 1e10, 10000)
#
#msa=xtest
#tau = 2e6
#tau_e=9e6
#
#ytest = msa*np.heaviside(tau-msa, 0) + tau*np.exp((tau-msa)/tau_e)*np.heaviside(msa-tau, 1)
#
