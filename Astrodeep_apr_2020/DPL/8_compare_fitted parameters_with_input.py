...
#        r'$M_\mathrm{tot}$'
        ...
        plt.legend()
        plt.tight_layout()
#        plt.savefig('/Users/lester/Dropbox/PhD/20_Summer/First Year Report/RawFigs/315_DPL_mass.png')
        plt.show()
...
#        plt.title('Input SFR (DE) vs Output SFR ({})'.format(title1), size=size)
        ...
        plt.legend()
        plt.tight_layout()
#        plt.savefig('/Users/lester/Dropbox/PhD/20_Summer/First Year Report/RawFigs/315_DPL_sfr.png')        
        plt.show()
